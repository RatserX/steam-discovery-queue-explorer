...
app.action = {
  document: () => {
    return `<div id="sqde-action" class="discovery_queue_customize_ctn">
...
app.activity = {
  document: () => {
    ...
    return `<div id="sqde-activity">
    <div id="sqde-activity-status" data-event data-event-listener="handleIsMaximizedState" data-event-type="state_isMaximized">
        <div class="info">
            <span>${localization.format(
              'exploreGame'
            )}: <span data-event data-event-listener="handleGameCountState" data-event-type="state_gameCount">${gameCount}</span></span>
        </div>
...
app.game = {
  document: (props) => {
    ...
    return `<a class="game" href="https://store.steampowered.com/app/${props.gameId}/${props.urlName}" id="sqde-game-${props.queueId}-${props.gameId}" target="_blank">
...
app.style = {
  document: () => {
    return `<style id="sqde-style" type="text/css">
